...
function Detail() {
    ...
    const param = useParams();  // it will return a js object containing slug key. Because in api.urls we define post/detail/<slug>. So useParams returns the key as whatever parameter was defined like slug, user_id, etc.
    ...
    const handleCreateCommentChange = (event) => {
        setCreateComment({
            ...createComment, [event.target.name]: event.target.value,
        });
    };
    
    const handleCreateCommentSubmit = async (e) => {
        e.preventDefault();  // The default action of submit is to reload the page. This prevents that.
        // When you don’t prevent the default form submission preventDefault():
        // 1. The form is submitted
        // 2. The page reloads immediately
        // 3. Your apiInstance.post() request is likely interrupted as default form submission cancels any asynchronous operations that hadn’t completed yet.
        // 4. So the comment never reaches the database
        ...
        fetchPost();  //  This is updating the states in the page.
                ...
                <div className="container position-relative" data-sticky-container="">
                    <div className="row">
                        ...
                        <div className="col-lg-10 mb-5">
                            ...
                            <div>
                                {/* .length property works here because comments is an array of json objects. */}
