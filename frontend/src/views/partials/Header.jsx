...
function Header() {
    ...
    return (
      // https://i.postimg.cc/ZRNC1mhM/my-main-logo.png
      <header
        className="navbar-dark navbar-sticky header-static"
          ...
          <div className="container">
            <Link className="navbar-brand" to="/">
              <img
                ...
                src="https://i.postimg.cc/j2gkw6ws/Blog-removebg-preview-1.png"
                style={{ width: "100px" }}
                alt="logo"
              />
            </Link>
            ...
            >
              <span className="h6 d-none d-sm-inline-block text-white">
                Menu
              </span>
